...
namespace beans.filters
{
    public class colorBLUE
    {
        ...
        public static Bitmap Run(Bitmap arg, ConfigSetting cfg)
        {
            ...
            {
                ((beans.blob_tag) arg.Tag).color = Color.Blue;
            }
        ...
        private static Image<Gray, Byte> DetectColorExist(Bitmap front, ConfigSetting cfg)
        {
            ...
            CvInvoke.InRange(imageHSV, new ScalarArray(new MCvScalar(100,150,0 )),
                new ScalarArray(new MCvScalar(140,255,255)), image1);
