...
namespace beans.filters
{
    public class colorGREEN
    {
        ...
        public static Bitmap Run(Bitmap arg, ConfigSetting cfg)
        {
            ...
            {
                ((beans.blob_tag) arg.Tag).color = Color.Green;
            }
        ...
        private static Image<Gray, Byte> DetectColorExist(Bitmap front, ConfigSetting cfg)
        {
            ...
            CvInvoke.InRange(imageHSV, new ScalarArray(new MCvScalar(25, 52, 72 )),
                new ScalarArray(new MCvScalar(102, 255, 255)), image1);
